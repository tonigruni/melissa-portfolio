    ...
    <section className="bg-surface-container py-32 relative overflow-hidden">
      ...
      <div className="px-margin-mobile md:px-margin-desktop relative z-10 flex flex-col items-center text-center">
        ...
        <div className="flex flex-col md:flex-row gap-gutter mt-8">
          ...
          <button className="border-2 border-on-surface text-on-surface px-12 py-6 font-label-bold text-label-bold uppercase hover:bg-primary hover:text-on-primary hover:border-primary transition-all">
            Start Project
          </button>
        </div>
      </div>
